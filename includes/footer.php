    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 footer-contacts">
            <div><span class="fa fa-map-marker footer-contacts-icon"> </span>
                <p><span class="new-line-span">411, Al-Sharqiyyah</span>Sur, Oman</p>
            </div>
            <div><i class="fa fa-phone footer-contacts-icon"></i>
                <p class="footer-center-info email text-left"> +968 95769612</p>
            </div>
            <div><i class="fa fa-envelope footer-contacts-icon"></i>
                <p> <a href="#" target="_blank">alimagoti95@gmail.com</a></p>
            </div>
        </div>
...
<script>
    ...
    // use this to output date <p>Date: <input type="text" id="datepicker"></p>
</script>
</body>
</html>